  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {totalItems > 0 && (
          <span className="animate-fade-in absolute -top-2.5 -right-2.5 sm:-top-3 sm:-right-3 bg-bib-white text-bib-black text-[9px] sm:text-[10px] w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center rounded-full font-medium">
            {totalItems}
          </span>
        )}
      </div>
